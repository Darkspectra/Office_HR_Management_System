...
// Route::get('/list', [hrController::class, 'cou']);
...
Route::get("showV/{id}", [hrController::class, 're']);
Route::post("showV/{id}", [hrController::class, 'repUpdate']);
Route::get("showAnswer", [hrController::class, 'showAns']);

//=======================Search Rep==================

Route::get('/showAnswer', [hrController::class, 'seaA']);
