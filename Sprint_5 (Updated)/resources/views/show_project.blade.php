...
<section id="header">
		<div class="row">
			<div class="col-md-2" style="font-size: 30px;color:#F2674A;">
				<a href="http://127.0.0.1:8000/assign"><button style="background-color: #89CFF0; font-size: 40px; color:white;"> Back </button> </a>
			</div>
		</div>
</section>

	<section id="section1">
		<div class="title" style="font-size: 40px;color:#F2674A; text-align: center;"> Assigned Projects </div>
		<div class="num">
		</div>
		<table border='1' width="300px" style="margin-left: 10%; margin-right: 10%; margin-top: 50px; margin-bottom: 50px; text-align: center; background: #66b3ff;">
            ...
            <tr class='row' style="padding: 5px;">
                ...
                <td class='del'> <a href={{"delete/".$member['id']}} data-toggle="tooltip" data-placement="bottom" title="delete"><button style="background-color: #f44336; font-size: 20px; color:white;"> Delete </button></a></td>
            </tr>
            @endforeach
