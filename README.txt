...
- HR can delete the assign project
- HR can view Employee information and projects assigned for each employee
...
- Visitor can see number of vacancy for each role
...
Easy multiple employee add:
- HR can add multiple employee by simply importing CSV file (non-functional requirement).
- Updated information can be showed less than approximately 2 second (non-functional requirement).
...
- Employee can add their detailed information like address, education qualification and skills.
- There will be "client info" page for separate employee
